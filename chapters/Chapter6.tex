...
\trans `Grape cannot survive the winter in the midland of RSFSR.'\\\Source{= example of verb usage from \citealt{Ushakov:50}}
\bg.\label{ex:dozimovat'}Dozimuem na korable vo l'dax.\\
do.winter.\glb{pres.pl.1} on ship in ice.\glb{pl.prep}\\
\trans `We will spend the rest of the winter on a ship in the ices.'\\\Source{= example of verb usage from \citealt{Ushakov:50}}
...
\trans `The expedition stayed on the Novaya Zemlya for the winter time.'\\\Source{= example of verb usage from \citealt{Ushakov:50}}
